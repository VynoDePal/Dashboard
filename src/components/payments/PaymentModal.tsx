          ...
          <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <select className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:text-white">
